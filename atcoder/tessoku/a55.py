...
なんか問題が分かりづらい気がするけどなんだろ。
xと書かれたカードは何枚あってもクエリ2ですべて消えるのか。
クエリ3で set をソートする必要がある。
これ、sorted_setみたいなものを作れないものか?
と思ったら C++ の set は sorted_set になっててにぶたんができるらしい。
Pythonにはこれがないから tatyam さんの SortedSet の実装をもらってきた。
